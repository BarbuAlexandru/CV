...
namespace PocketPlane.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (Input.Role == "Admin")
                    {
                        ...
                        IdentityUser userAdmin = await _userManager.FindByNameAsync(Input.Username);
                    ...
                    else
                    {
                        clientsService.CreateClient(user.Id, Input.FirstName, Input.LastName, Input.Email, Input.PhoneNo, 
                                                    Input.Address, Input.CI_Passport);
                        IdentityUser userClient = await _userManager.FindByNameAsync(Input.Username);
